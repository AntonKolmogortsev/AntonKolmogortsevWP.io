        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="contacts__map">
                    <?php echo do_shortcode('[yamap center="55.7798,37.6990" height="100%" controls="" zoom="11" type="yandex#map" scrollzoom="0" mobiledrag="0"][/yamap]');     ?>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="contacts__phones">
                        ...
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="<?php the_field('phone2'); ?>"><?php the_field('phone2'); ?></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <?php echo do_shortcode('[contact-form-7 id="146" title="Форма отзывы"]'); ?>
                </div>
            </div>
        </div>
        <div class="row mt70">
